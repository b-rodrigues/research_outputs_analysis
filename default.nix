# This file was generated by the {rix} R package v0.16.0 on 2025-07-15
# with following call:
# >rix(date = "2025-07-14",
#  > r_pkgs = c("R_utils",
#  > "archive",
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-07-14.tar.gz") {};
